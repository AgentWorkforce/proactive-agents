...
export function SiteLogo({
  ...
  const fadedFill = secondary ?? primary;
  return (
    <svg
      viewBox="0 0 112 91"
      fill="none"
    ...
    >
      ...
      />
      <path
        d="M75.5711 72.8243C78.9563 76.2096 84.445 76.2096 87.8302 72.8243L109.359 51.2952C112.745 47.9099 112.745 42.4213 109.359 39.036L87.8302 17.507C84.445 14.1218 78.9563 14.1218 75.5711 17.507L71.3702 21.7079L88.6989 39.0405C92.0842 42.4258 92.0842 47.9144 88.6989 51.2997L71.3727 68.6259L75.5711 72.8243Z"
        fill={fadedFill}
        opacity={secondary ? 1 : secondaryOpacity}
      />
    </svg>
  );
}
