...
| `/voice` | CLAUDE.md "Writing Voice & Editorial" section + essay-authoring.md voice guardrails |
...
| `/modules` | `.agentworkforce/workforce/skills/` |
| `/workflows` | essay-authoring.md (full authoring workflow) |
...
- **Constraints**: Pull from CLAUDE.md voice rules, essay-authoring.md checklist, and this skill's avoid-slop patterns.
...
- **essay-authoring.md**: Handles the mechanical writing patterns (Scene components, figure creation, MDX structure). This skill handles the strategic layer (what to write, why, for whom, and quality gates).
