...
**[Gemini Spark](/posts/google-spark-io-2026/) (Google)** launched at I/O 2026 (previously codenamed "Remy"). Powered by Gemini 3.5 on dedicated Cloud VMs with the "Antigravity" orchestration harness, it runs 24/7 across five surfaces: Gemini app, email, chat, Android Halo, and Chrome agentic browser. Google services connect natively; third-party tools connect via Anthropic's MCP. Beta is open to AI Ultra subscribers in the US. All three primitives are present, with the broadest surface area of any entrant.
