...
summary: "Every major AI lab is building proactive agents. Here's who shipped what, how they score on the three primitives, and where the gaps still are. Updated May 2026."
date: "2026-05-11"
accent: "sage"
dropcap: true
---

Six months ago, proactive AI was a research concept. Today, every major AI lab either has a proactive agent product in market or has one in internal testing. The convergence is striking: OpenAI, Google, Anthropic, Meta, Perplexity, and several startups are all building agents that act without being asked.
...
Managerbot and Writer share something the horizontal assistants don't have: a bounded problem space. When you know the user is a restaurant owner or a marketing team, you can make stronger assumptions about what "proactive" means. The horizontal assistants have to figure out what matters to each user from scratch.
</Callout>
...
Every product on this list arrived at roughly the same architecture independently. Scheduled execution, change detection, multi-channel delivery. The [three-primitives framework](/posts/three-primitives) wasn't predictive so much as descriptive: this is simply what proactive agents need to work.
...
The products that nail all three at depth will be the ones people reorganize their workflows around. The ones that ship a clock and call it proactive will end up feeling like [another tab to check](/posts/chatgpt-pulse).
...
The landscape is moving fast. I'll keep this page updated as products ship and the primitives picture changes.
