...
Anyway, that's what it looks like when you build the watcher from scratch, one provider at a time. It's a ton of work, and most of it has nothing to do with the agent itself.
