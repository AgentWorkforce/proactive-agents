...
The session abstraction is where Open-Inspect diverges most from other background agents. A session isn't just a task. It's a persistent, stateful workspace that multiple users can join simultaneously.
