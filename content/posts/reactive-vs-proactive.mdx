...
Push and persistence beat pull and statelessness — in agents the same way they do in every other distributed system. The reason agents are still mostly reactive isn't that nobody figured this out. It's that the runtime to make them proactive didn't exist as a primitive you could import.
